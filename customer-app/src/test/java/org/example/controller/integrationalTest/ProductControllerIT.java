...
class ProductControllerIT {
    ...
    void createReview_RequestIsValid_RedirectsToProductPage() {
        ...
        verify(getRequestedFor(urlPathMatching("/feedback-api/product-reviews"))
                .withHeader(HttpHeaders.CONTENT_TYPE, equalTo(MediaType.APPLICATION_JSON_VALUE))
                .withRequestBody(equalToJson("""
                    {
                        "productId": 1,
    ...
    void createReview_RequestIsInvalid_ReturnsProductPage() throws Exception {
                ...
                .withRequestBody(equalToJson("""
                    {
                        "productId": 1,
                        "rating": -1,
                        "review": "Too long review (more than 1000 symbols)"
                    }
                """))
        ...
        this.webTestClient.mutateWith(mockUser())
                ...
                .body(BodyInserters.fromFormData("rating", "-1")
                        .with("review", "Too long review (more than 1000 symbols)"))
        ...
        verify(postRequestedFor(urlPathMatching("/feedback-api/product-reviews"))
                .withHeader(HttpHeaders.CONTENT_TYPE, equalToJson(MediaType.APPLICATION_JSON_VALUE))
                .withRequestBody(equalToJson("""
                            {
                              "productId": 1,
                              "rating": -1,
