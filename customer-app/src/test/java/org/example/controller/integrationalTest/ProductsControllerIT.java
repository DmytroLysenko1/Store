...
public class ProductsControllerIT {
                    ...
                    [
                        {
                            ...
                            "details" : "Filtered product description №1"
                        },
                        {
                            "id" : 2,
                            "title" : "Filtered product №2",
                            "details" : "Filtered product description №2"
                        },
                        {
                            "id" : 3,
                            "title" : "Filtered product №3",
                            "details" : "Filtered product description №3"
                        }
                    ]
                """)));
    }
    ...
    @Test
    void getProductListPage_ReturnsProductsPage() {
        //given
    ...
    @Test
    void getProductListPage_UserIsNotAuthenticated_RedirectsToLoginPage() {
        //given
