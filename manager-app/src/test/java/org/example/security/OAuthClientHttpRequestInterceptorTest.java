...
public class OAuthClientHttpRequestInterceptorTest {
    ...
    void setup(){
        this.interceptor =
                new OAuthClientHttpRequestInterceptor(this.authorizedClientManager, "test");
    }
    ...
    void intercept_AuthorizationHeaderIsNotSet_AddsAuthorizationHeader() throws IOException {
        ...
        TestingAuthenticationToken authentication = new TestingAuthenticationToken("j.dewar", "password");
        SecurityContextHolder.getContext().setAuthentication(authentication);

        OAuth2AuthorizedClient authorizedClient =
                new OAuth2AuthorizedClient(mock(), "j.dewar",
        ...
        doReturn(authorizedClient).when(this.authorizedClientManager).authorize(
                argThat(authorizationRequest ->
        ...
        //when
        ClientHttpResponse result = this.interceptor.intercept(request, body, execution);
