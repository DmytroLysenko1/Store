...
import org.example.service.favourite.DefaultFavouriteProductsServiceImpl;
...
public class DefaultFavouriteProductsServiceTest {

    @Mock
    FavouriteProductRepository favouriteProductRepository;

    @InjectMocks
    DefaultFavouriteProductsServiceImpl service;
    ...
    void addProductToFavourites_ReturnsCreatedFavouriteProduct() {
        ...
        //when
        StepVerifier.create(this.service.addToFavourites(1, "5f1d5cf8-cbd6-11ee-9579-cf24d050b47c"))
                //then
    ...
    @Test
    void removeProductFromFavourite_ReturnsEmptyMono() {
        //given
    ...
    void findFavouriteProductByProduct_ReturnsFavouriteProduct() {
        ...
        doReturn(Mono.just(new FavouriteProduct(
                UUID.fromString("fe87eef6-cbd7-11ee-aeb6-275dac91de02"),
                1,
        ...
        StepVerifier.create(this.service
                ...
                //then
                .expectNext(new FavouriteProduct(
                        UUID.fromString("fe87eef6-cbd7-11ee-aeb6-275dac91de02"),
                        1,
                        "5f1d5cf8-cbd6-11ee-9579-cf24d050b47c"))
                .verifyComplete();
    ...
    void findFavouriteProducts_ReturnsFavouriteProducts() {
        ...
        StepVerifier.create(this.service.findFavouriteProducts("5f1d5cf8-cbd6-11ee-9579-cf24d050b47c"))
                //then
                .expectNext(new FavouriteProduct(UUID.fromString("fe87eef6-cbd7-11ee-aeb6-275dac91de02"), 1,
                                "5f1d5cf8-cbd6-11ee-9579-cf24d050b47c"),
                        new FavouriteProduct(UUID.fromString("23ff1d58-cbd8-11ee-9f4f-ef497a4e4799"), 3,
                                "5f1d5cf8-cbd6-11ee-9579-cf24d050b47c"))
                .verifyComplete();
