...
public class FavouriteProductsRestControllerIT {
    ...
    void findFavouriteProducts_ReturnsFavouriteProducts() {
        ...
        this.webTestClient.mutateWith(mockJwt()
                .jwt(builder -> builder.subject("5f1d5cf8-cbd6-11ee-9579-cf24d050b47c")))
                .get()
    ...
    void addFavouriteProduct_RequestIsValid_ReturnsCreatedFavouriteProduct() {
        ...
        //when
        this.webTestClient.mutateWith(mockJwt().jwt(builder -> builder.subject("5f1d5cf8-cbd6-11ee-9579-cf24d050b47c")))
                .post()
                .uri("/feedback-api/favourite-products")
    ...
    void addFavouriteProduct_RequestIsInvalid_ReturnsBadRequest() {
        ...
        this.webTestClient.mutateWith(mockJwt()
                ...
                .expectBody().json("""
                    {
                        "errors" : ["Product was not specified"]
                    }
                """);
    }
