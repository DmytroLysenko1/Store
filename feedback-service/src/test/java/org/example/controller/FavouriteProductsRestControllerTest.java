...
public class FavouriteProductsRestControllerTest {
    ...
    void findFavouriteProducts_ReturnsFavouriteProducts() {
        ...
        doReturn(
                Flux.fromIterable(List.of(
                        new FavouriteProduct(UUID.fromString(
                                "fe87eef6-cbd7-11ee-aeb6-275dac91de02"), 1,
                                "5f1d5cf8-cbd6-11ee-9579-cf24d050b47c"),
                        new FavouriteProduct(UUID.fromString(
                                "23ff1d58-cbd8-11ee-9f4f-ef497a4e4799"), 3,
                                "5f1d5cf8-cbd6-11ee-9579-cf24d050b47c"
                )))).when(this.favouriteProductsService)
                .findFavouriteProducts("5f1d5cf8-cbd6-11ee-9579-cf24d050b47c");
    ...
    void addProductToFavourites_ReturnsCreatedFavouriteProduct() {
        //given
        doReturn(Mono.just(new FavouriteProduct(UUID.fromString(
                "fe87eef6-cbd7-11ee-aeb6-275dac91de02"), 1,
                "5f1d5cf8-cbd6-11ee-9579-cf24d050b47c")))
                .when(this.favouriteProductsService)
                .addToFavourites(1, "5f1d5cf8-cbd6-11ee-9579-cf24d050b47c");
        ...
        StepVerifier.create(this.controller.addProductToFavourites(Mono.just(new JwtAuthenticationToken(Jwt.withTokenValue("e30.e30")
                ...
                .expectNext(ResponseEntity.created(
                        URI.create("http://localhost/feedback-api/favourite-products/fe87eef6-cbd7-11ee-aeb6-275dac91de02"))
